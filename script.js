...
To accomplish this, the function should create the new card element (i.e. .card), append it as a child to the parentElement (i.e. #card-container), and return the new card element.
*/
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  let cardObjects = [];
    ...
    // newCard = shuffledImageClasses[i];
    }
...
function onCardFlipped(newlyFlippedCard) {
  ...
  lastCardFlipped.element.classList.add("glowing");
  newlyFlippedCard.element.classList.add("glowing");
